...
namespace Datos
{
    public class PersonaRepository
    {
        ...
        public void Guardar(Persona persona)
        {
            ...
            {
                command.CommandText = @"Insert Into Persona (Identificacion,Nombre,Apellido,Sexo,Edad,Departamento,Ciudad,Tipo,Valor,Fecha) 
                                        values (@Identificacion,@Nombre,@Apellido,@Sexo,@Edad,@Departamento,@Ciudad,@Tipo,@Valor,@Fecha)";
                ...
                command.Parameters.AddWithValue("@Tipo", persona.Tipo);
